...
list(zip(* ([1,2,3],[4,5,6]))) #> [(1, 4), (2, 5), (3, 6)]
list(zip(* [(1, 4), (2, 5), (3, 6)]))       #> [(1, 2, 3), (4, 5, 6)]
list(zip(* list(zip(* ([1,2,3],[4,5,6]))))) #> [(1, 2, 3), (4, 5, 6)]
tuple(zip(* list(zip(* ([1,2,3],[4,5,6])))))  #> ((1, 2, 3), (4, 5, 6))
tuple(zip(* tuple(zip(* ([1,2,3],[4,5,6]))))) #> ((1, 2, 3), (4, 5, 6))
